...
var __commonjs__1 = require("./init/__commonjs__");
/**
 * init
 *
 * @export
...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        var name, description, repository, author, packageInfor, isInit_webpack, isInit_commonjs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 10:
                    _a.sent();
                    return [3 /*break*/, 15];
                case 11: return [4 /*yield*/, saber_node_1.Terminal.getUserInput('config saber-commonjs?(y/n): ')];
                case 12:
                    isInit_commonjs = _a.sent();
                    if (!(isInit_commonjs === 'y')) return [3 /*break*/, 15];
                    return [4 /*yield*/, __html__1.init_Html(packageInfor)];
                case 13:
                    _a.sent();
                    return [4 /*yield*/, __commonjs__1.init_commonjs()];
                case 14:
                    _a.sent();
                    _a.label = 15;
                case 15: return [4 /*yield*/, __gitignore__1.init_gitignore()];
                case 16:
                    _a.sent();
                    return [2 /*return*/];
            }
