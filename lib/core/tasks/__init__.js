...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        var name, description, repository, author, packageInfor;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    // resolve
                    return [4 /*yield*/, __package__1.initPackageJson(packageInfor)];
                case 5:
                    // resolve
                    _a.sent();
                    return [4 /*yield*/, __html__1.initHtml(packageInfor)];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, __readme__1.initReadMe(packageInfor)];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, __tsconfig__1.initTsConfig()];
                case 8:
                    _a.sent();
                    return [4 /*yield*/, __webpackConfig__1.initWebpackConfig()];
                case 9:
                    _a.sent();
                    return [2 /*return*/];
            }
