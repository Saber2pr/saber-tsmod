...
var __rollupConfig__1 = require("./init/__rollupConfig__");
...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        var name, description, repository, author, packageInfor, Init_Options;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    name = _a.sent();
                    if (!name) {
                        print_1.Fail.Task.initFail('<Package name> cannot be null!');
                        return [2 /*return*/];
                    }
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, __tsconfig__1.init_Tsconfig()];
                case 7:
                    _a.sent();
                    return [4 /*yield*/, saber_node_1.Terminal.getUserInput(terminal_view_1.TerminalLog.Select.config)];
                case 8:
                    Init_Options = _a.sent();
                    if (!(Init_Options === '1')) return [3 /*break*/, 11];
                ...
                case 10:
                    ...
                    return [3 /*break*/, 14];
                case 11:
                    if (!(Init_Options === '2')) return [3 /*break*/, 14];
                    return [4 /*yield*/, __html__1.init_Html(packageInfor)];
                case 12:
                    _a.sent();
                    return [4 /*yield*/, __rollupConfig__1.init_rollupConfig()];
                case 13:
                    _a.sent();
                    _a.label = 14;
                case 14: return [4 /*yield*/, __gitignore__1.init_gitignore()];
                case 15:
                    _a.sent();
                    return [2 /*return*/];
            }
