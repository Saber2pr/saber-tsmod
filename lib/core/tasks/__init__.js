...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, saber_node_1.Path.isExist(path_config_1.path_packageJson)];
                case 1:
                    if (_a.sent()) {
                        print_1.Fail.Task.initFail('package.json is exist!');
                    }
                    return [4 /*yield*/, saber_node_1.Terminal.getUserInput('Package name: ')];
                case 2:
                    name = _a.sent();
                    if (!name) {
                ...
                case 9:
                    ...
                    if (!(isInit_webpack === 'y')) return [3 /*break*/, 12];
                ...
                case 11:
                    _a.sent();
                    _a.label = 12;
                case 12: return [4 /*yield*/, __gitignore__1.init_gitignore()];
                case 13:
                    _a.sent();
                    print_1.Success.Task.initSuccessfully();
                    return [2 /*return*/];
            }
        });
    });
