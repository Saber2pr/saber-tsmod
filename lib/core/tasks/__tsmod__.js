        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    module_test = "import { test_" + rename + " } from '../" + path_config_1.tsmodJson.test + "/test_" + rename + "'\ntest_" + rename + "()\n\n";
                ...
                case 5:
                    ...
                    _a.label = 6;
                case 6:
                    export_entry = path_config_1.path_src + "/index.ts";
                    export_entry_content = "export * from './" + path_config_1.tsmodJson.core + "/" + name + "'\n";
