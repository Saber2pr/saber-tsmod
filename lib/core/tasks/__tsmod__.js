        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, saber_node_1.File.pushFile(test_entry, module_test)];
                case 5:
                    _a.sent();
                    _a.label = 6;
                case 6:
                    ...
                    export_entry_content = "export * from '" + path_config_1.core + "/" + name + "'";
                    return [4 /*yield*/, saber_node_1.File.createFile(export_entry, export_entry_content)];
                case 7:
                    _a.sent();
                    _a.label = 8;
                case 8: return [2 /*return*/, moduleFilePath];
            }
        });
    });
}
