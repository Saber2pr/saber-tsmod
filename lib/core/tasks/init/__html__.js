 ...
 * @Last Modified time: 2019-01-13 14:15:57
 */
...
function init_Html(packageInfor) {
    return __awaiter(this, void 0, void 0, function () {
        var name, description, repository, author, html, html_content;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, saber_node_1.File.createFile(html, html_content)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
