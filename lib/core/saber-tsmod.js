    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (params.length > 0) {
                ...
                console.log(terminal_view_1.TerminalLog.Hello);
            }
            return [2 /*return*/];
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    res = _a.sent();
                    console.log(terminal_view_1.TerminalLog.Status.modulePath(res));
                    return [3 /*break*/, 3];
                case 2:
                    console.log(terminal_view_1.TerminalLog.Help.create);
                    _a.label = 3;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [3 /*break*/, 5];
                case 1: return [4 /*yield*/, __tsconfig__1.initTsConfig()];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 6];
                case 3: return [4 /*yield*/, __webpackConfig__1.initWebpackConfig()];
                case 4:
                    _b.sent();
                    return [3 /*break*/, 6];
                case 5:
                    console.log(terminal_view_1.TerminalLog.Help.config);
                    return [3 /*break*/, 6];
