...
var __commonjs__1 = require("./tasks/init/__commonjs__");
/**
 * main_create
 *
 * @param {string} param
            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case terminal_view_1.Options.ConfigItems.commonjs: return [3 /*break*/, 7];
                    }
                    return [3 /*break*/, 9];
                ...
                case 6:
                    _b.sent();
                    return [3 /*break*/, 10];
                case 7: return [4 /*yield*/, __commonjs__1.init_commonjs()];
                case 8:
                    _b.sent();
                    return [3 /*break*/, 10];
                case 9:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(params.length > 0)) return [3 /*break*/, 8];
                ...
                case 1:
                    ...
                    return [3 /*break*/, 7];
                case 2:
                    if (!(params[0] === terminal_view_1.Options.Params.create)) return [3 /*break*/, 4];
                    return [4 /*yield*/, main_create(params[1])];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 4:
                    if (!(params[0] === terminal_view_1.Options.Params.config)) return [3 /*break*/, 6];
