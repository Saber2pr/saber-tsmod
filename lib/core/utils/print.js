...
(function (Success) {
    var Task;
    (function (Task) {
        Task.initSuccessfully = function (taskName, message) {
            saber_node_1.Terminal.Print.tips("--- init " + taskName + " successfully ---");
            if (message) {
                saber_node_1.Terminal.Print.success(message);
            }
        };
        Task.configSuccessfully = function (taskName, message) {
            saber_node_1.Terminal.Print.tips("--- config " + taskName + " successfully ---");
            if (message) {
                saber_node_1.Terminal.Print.success(message);
            }
        };
